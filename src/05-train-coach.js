...
export function findPassenger(passengers, name) {
  ...
  return passengers.find(passenger => passenger.name != null && passenger.name.toLowerCase() === name.toLowerCase());
}
...
export function getPassengerIndex(passengers, name) {
  ...
  return passengers.findIndex(passenger => passenger.name != null && passenger.name.toLowerCase() === name.toLowerCase());
}
